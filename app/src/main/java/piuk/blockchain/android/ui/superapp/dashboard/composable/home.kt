...
@Composable
fun HomeScreen(modifier: Modifier = Modifier, indexedChanged: (Pair<Int, Int>) -> Unit) {
    val listState = rememberLazyListState()

    println("----- listState.firstVisibleItemIndex home ${listState.firstVisibleItemIndex}")
...
@Composable
fun CardScreen(modifier: Modifier = Modifier, indexedChanged: (Pair<Int, Int>) -> Unit) {
    val listState = rememberLazyListState()
