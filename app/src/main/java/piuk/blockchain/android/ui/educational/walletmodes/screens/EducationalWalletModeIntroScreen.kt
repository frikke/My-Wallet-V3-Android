...
@Composable
fun EducationalWalletModeIntroScreen() {
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.educational_wallet_mode_intro_title),
                ...
                Text(
                    text = stringResource(R.string.educational_wallet_mode_intro_description),
...
fun PreviewEducationalWalletModeIntroScreen() {
    EducationalWalletModeIntroScreen()
}
