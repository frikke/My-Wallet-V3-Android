...
public class WalletBaseTest extends MockedResponseTest {
    ...
    public void romJson_v3_1f() throws Exception {
        ...
        WalletBase walletBaseBody = WalletBase.fromJson(walletBase, true);
        ...
        walletBaseBody.decryptPayload("MyTestWallet", true);
    ...
    public void fromJson_v3_2() throws Exception {
        ...
        walletBaseBody.decryptPayload("SomeTestPassword", true);
        Assert.assertEquals(5000, walletBaseBody.getWalletBody().getOptions().getPbkdf2Iterations());
        Assert.assertNotNull(walletBaseBody.getWalletBody());
    ...
    public void fromJson_v1_1() throws Exception {
        ...
        walletBaseBody.decryptPayload("mypassword", true);
        Assert.assertNotNull(walletBaseBody.getWalletBody());
    ...
    public void encryptAndWrapPayload() throws Exception {
        ...
        //Encrypt
        Pair pair = walletBaseBody.encryptAndWrapPayload("MyTestWallet", true);
        ...
        Wallet walletBody = encryptedwalletWrapper.decryptPayload("MyTestWallet", true);
        Assert.assertEquals("a09910d9-1906-4ea1-a956-2508c3fe0661", walletBody.getGuid());

        ///////Encrypt with different iterations//////
        //Decrypt
        walletBaseBody = WalletBase.fromJson(walletBase, true);
        walletBaseBody.decryptPayload("MyTestWallet", true);
        walletBaseBody.getWalletBody().getOptions().setPbkdf2Iterations(7500);

        //Encrypt
        pair = walletBaseBody.encryptAndWrapPayload("MyTestWallet", true);
        ...
        //Decrypt again to check payload intact
        walletBody = encryptedwalletWrapper.decryptPayload("MyTestWallet", true);
        Assert.assertEquals("a09910d9-1906-4ea1-a956-2508c3fe0661", walletBody.getGuid());
        ...
        //Encrypt
        pair = walletBaseBody.encryptAndWrapPayload("MyNewTestWallet", true);
        ...
        //Decrypt again to check payload intact
        walletBody = encryptedwalletWrapper.decryptPayload("MyNewTestWallet", true);
        Assert.assertEquals("a09910d9-1906-4ea1-a956-2508c3fe0661", walletBody.getGuid());
    }
