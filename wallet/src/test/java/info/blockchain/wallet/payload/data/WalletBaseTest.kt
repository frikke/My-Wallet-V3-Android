...
class WalletBaseTest : MockedResponseTest() {
    ...
    fun fromJson_v3_1f() {
        ...
        Assert.assertEquals(
            "d78bf97da866cdda7271a8de0f2d101caf43ae6280b3c69b85bf82d367649ea7", walletBaseBody.payloadChecksum
        )
    ...
    fun fromJson_v3_2() {
        ...
        Assert.assertEquals(
            "7416cd440f7b15182beb15614a63d5e53b3a6f65634d2b160884c131ab336b01", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet.options.pbkdf2Iterations)
        Assert.assertEquals(5000, walletBaseBody.wallet.options.pbkdf2Iterations)
        Assert.assertNotNull(walletBaseBody.wallet)
    ...
    fun fromJson_v3_3() {
        ...
        val walletBaseBody = fromJson(walletBase).withDecryptedPayload("SomeTestPassword")
        Assert.assertEquals(
            "fc631f8434f45c43e7040f1192b6676a8bd49e0fd00fb4848acdc0dcaa665400", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet.options.pbkdf2Iterations)
    ...
    fun fromJson_v2_3() {
        ...
        val walletBaseBody = fromJson(walletBase).withDecryptedPayload("SomeTestPassword")
        Assert.assertEquals(
            "110764d05c020d4818e2529ca28df9d8b96d50c694650348f885fc075f9366d5", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet.options.pbkdf2Iterations)
        Assert.assertEquals(5000, walletBaseBody.wallet.options.pbkdf2Iterations)
        Assert.assertNotNull(walletBaseBody.wallet)
    ...
    fun fromJson_v2_2() {
        ...
        val walletBaseBody = fromJson(walletBase).withDecryptedPayload("SomeTestPassword")
        Assert.assertEquals(
            "31b162d3e1fd0b57d8b7dd1202c16604be221bde2fe0192fc0a4e7ce704d3446", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet.options.pbkdf2Iterations)
    ...
    @Test @Throws(Exception::class) fun fromJson_v1_1() {
        ...
        Assert.assertEquals(
            "26c0477b045655bb7ba3e81fb99d7e8ce16f4571400223026169ba8e207677a4", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet)
    ...
    fun fromJson_v1_2() {
        ...
        val walletBaseBody = fromJson(walletBase).withDecryptedPayload("mypassword")
        Assert.assertEquals(
            "57f97ace89c105c19c43a15f2d6e3091d457dec804243b15772d2062a32f8b7d", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet)
    ...
    fun fromJson_v1_3() {
        ...
        val walletBaseBody = fromJson(walletBase).withDecryptedPayload("mypassword")
        Assert.assertEquals(
            "a4b67f406268dced75ac5c628da854898c9a3134b7e3755311f199723d426765", walletBaseBody.payloadChecksum
        )
        Assert.assertNotNull(walletBaseBody.wallet)
