...
import com.blockchain.componentlib.theme.getDarkColors
import com.blockchain.componentlib.theme.getLightColors
...
object ViewSystemUtils {
    ...
    fun getSemanticColors(context: Context): SemanticColors {
        ...
        return if (isInDarkMode) getDarkColors() else getLightColors()
    }
}
