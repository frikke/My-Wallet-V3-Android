...
private val SuccessLight = Color(0xFFEDFFFA)
private val SuccessLightNight = Color(0xFFEDFFFA) // missing
...
val defLightColors = SemanticColors(
    ...
    successLight = SuccessLight, // missing dark
    warning = Warning, //
...
val defDarkColors = SemanticColors(
    ...
    successMuted = Green300,
    successLight = SuccessLightNight,
