...
@Composable
private fun EnterSecondPasswordScreen(
...
@Preview
@Composable
private fun PreviewEnterSecondPasswordScreen() {
    EnterSecondPasswordScreen(
        isShowingError = false,
...
@Composable
private fun PreviewEnterSecondPasswordScreenDark() {
    PreviewEnterSecondPasswordScreen()
}