            ...
            Column(
                ...
                if (isDebugBuild) {
                    Text(
                        ...
                        color = Grey900,
                        textAlign = TextAlign.Center,
                        text = "Debug Build - Press back to skip"
                    )
                    Spacer(Modifier.size(dimensionResource(R.dimen.tiny_margin)))
                }
