...
abstract class MVIDialogFragment<TViewState : ViewState> : DialogFragment() {
    abstract fun onStateUpdated(state: TViewState)
}

fun <TViewState : ViewState, TFragment : MVIDialogFragment<TViewState>, TArgs : ParcelableArgs> TFragment.withArgs(
    key: String,
    args: TArgs
): TFragment = apply {
...
fun <TIntent : Intent<TModelState>,
    ...
    > MVIDialogFragment<TViewState>.bindViewModel(
