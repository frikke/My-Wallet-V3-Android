...
sealed interface ChromeBottomNavigationItem {
    ...
    object Home : ChromeBottomNavigationItem {
        override val name: Int = com.blockchain.stringResources.R.string.chrome_navigation_home
    ...
    object Prices : ChromeBottomNavigationItem {
        override val name: Int = com.blockchain.stringResources.R.string.chrome_navigation_prices
    ...
    object Nft : ChromeBottomNavigationItem {
        override val name: Int = com.blockchain.stringResources.R.string.chrome_navigation_nft
    ...
    object Dex : ChromeBottomNavigationItem {
        override val name: Int = com.blockchain.stringResources.R.string.chrome_navigation_dex
    ...
    object Earn : ChromeBottomNavigationItem {
        override val name: Int = com.blockchain.stringResources.R.string.chrome_navigation_earn
